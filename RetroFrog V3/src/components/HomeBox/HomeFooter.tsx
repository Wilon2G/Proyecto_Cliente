    ...
    <footer id="footer">
      ...
      <div className="footer--info">
        ...
        <div>
          ...
          <ul>
            <li>Informes de analistas</li>
            <li>Impacto social</li>
            <li>Cultura e inclusión</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul>
            <li>Inversores</li>
            <li>Socios</li>
            <li>Estudiantes y educadores</li>
          </ul>
        </div>
      </div>
      <div>
        <h2 style={{ textAlign: "center" }}>Nuestras redes</h2>
        <br />
        <a style={{ margin: "1rem" }} href="https://x.com/oracle_es">
          <svg
            fill="#ffffff"
            height="2.25rem"
            width="2.25rem"
        ...
        <a style={{ margin: "1rem" }} href="https://www.facebook.com/Oracle/">
          <svg
            fill="#ffffff"
            height="2.25rem"
            width="2.25rem"
        ...
        <a style={{ margin: "1rem" }} href="https://www.youtube.com/oracle">
          <svg
            width="2.25rem"
            height="2.25rem"
            viewBox="0 -3 20 20"
        ...
        <a
          style={{ margin: "1rem" }}
          href="https://github.com/Wilon2G/Proyecto_Cliente"
        >
          <svg
            width="2.25rem"
            height="2.25rem"
