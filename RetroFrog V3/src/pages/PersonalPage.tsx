        ...
        <div className="signup__wrapper">
            <form className="signup__form" onSubmit={handleSubmit}>
                ...
                <div className="signup__form--input-field">
                    <input value={userName} onChange={e => setUsername(e.target.value)} placeholder={sessionStorage.getItem('username')} required></input>
                ...
                <div className="signup__form--input-field">
                    <input value={name} onChange={e => setName(e.target.value)} placeholder={sessionStorage.getItem('name')}required></input>
                    <label>Enter your NEW full name </label>
                </div>

                <div className="signup__form--input-field">
                    <input value={email} onChange={e => setEmail(e.target.value)} type="email" placeholder={sessionStorage.getItem('email')} required></input>
                    <label>Enter your NEW email </label>
                </div>

                <p><b>Change your gender</b></p>
                ...
                <Link className="signup__form--back" to={'/'}>Back</Link>
            </form>
        </div>
    );
};
