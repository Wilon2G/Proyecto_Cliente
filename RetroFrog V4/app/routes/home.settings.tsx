      ...
      <div className="dropdown h-fit">
        ...
        >
          ...
          <p>
            ...
            maneras, incluyendo cuando visitan nuestro sitio web, realizan
            compras o interactúan con nuestros servicios. Los tipos de
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>
              ...
              usuario, personalizar el contenido y analizar el tráfico del
              sitio.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-6 mb-4">
            <li>
              ...
              información con proveedores de servicios de pago, servicios de
              envío y otros socios que nos ayudan a operar nuestro negocio,
              siempre que estos proveedores se comprometan a proteger su
              información.
            </li>
            <li>
              <strong>Cumplimiento Legal:</strong> podemos divulgar su
              información si es requerido por la ley o en respuesta a una
              solicitud válida de una autoridad gubernamental o judicial.
            </li>
            <li>
              <strong>Transferencias de Negocios:</strong> en caso de fusión,
              adquisición o venta de RetroFrog, su información personal puede
              ser transferida como parte de la transacción, pero siempre bajo
              las condiciones de privacidad acordadas.
            </li>
          </ul>
          ...
          <p>
            ...
            personal que tenemos sobre usted. También puede solicitar que
            dejemos de enviarle comunicaciones de marketing en cualquier
            momento. Para ejercer estos derechos, por favor, contacte con
            nosotros a través de la información proporcionada al final de esta
            política.
          </p>
          ...
          <p>
            ...
            pero algunas funcionalidades del sitio pueden no estar disponibles
            si lo hace.
          </p>
          ...
          <p>
            ...
            somos responsables de las prácticas de privacidad ni del contenido
            de estos sitios. Le recomendamos que revise las políticas de
            privacidad de los sitios de terceros antes de proporcionarles
